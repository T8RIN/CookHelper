...
sealed interface ColorScheme {
    ...
    object DarkBlue : ColorScheme {
        ...
        override val md_theme_light_primaryContainer = Color(0xFFB8BAFF)
        ...
        override val md_theme_light_secondaryContainer = Color(0xFFCCCEFF)
        ...
        override val md_theme_light_background = Color(0xFFE5E5FF)
        override val md_theme_light_onBackground = Color(0xFF1B1B1F)
        override val md_theme_light_surface = Color(0xFFE5E5FF)
        override val md_theme_light_onSurface = Color(0xFF1B1B1F)
        override val md_theme_light_surfaceVariant = Color(0xFFD0C8F0)
        ...
        override val md_theme_dark_secondaryContainer = Color(0xFF2D3157)
        ...
        override val md_theme_dark_background = Color(0xFF10103F)
        override val md_theme_dark_onBackground = Color(0xFFE4E1E6)
        override val md_theme_dark_surface = Color(0xFF10103F)
        override val md_theme_dark_onSurface = Color(0xFFE4E1E6)
        override val md_theme_dark_surfaceVariant = Color(0xFF32324E)
    ...
    object Blue : ColorScheme {
        ...
        override val md_theme_light_onPrimary = Color(0xFFFFFFFF)
        override val md_theme_light_primaryContainer = Color(0xFFB6E1FF)
        override val md_theme_light_onPrimaryContainer = Color(0xFF001E2C)
        override val md_theme_light_secondary = Color(0xFF4E616D)
        override val md_theme_light_onSecondary = Color(0xFFFFFFFF)
        override val md_theme_light_secondaryContainer = Color(0xFFC0DCF1)
        ...
        override val md_theme_light_onError = Color(0xFFFFFFFF)
        override val md_theme_light_onErrorContainer = Color(0xFF410002)
        override val md_theme_light_background = Color(0xFFE7F5FF)
        override val md_theme_light_onBackground = Color(0xFF191C1E)
        override val md_theme_light_surface = Color(0xFFE7F5FF)
        override val md_theme_light_onSurface = Color(0xFF191C1E)
        override val md_theme_light_surfaceVariant = Color(0xFFD4DEE9)
        override val md_theme_light_onSurfaceVariant = Color(0xFF273A47)
        override val md_theme_light_outline = Color(0xFF5D6E7C)
        ...
        override val md_theme_dark_onError = Color(0xFF690005)
        override val md_theme_dark_onErrorContainer = Color(0xFFFFDAD6)
        override val md_theme_dark_background = Color(0xFF03141F)
        override val md_theme_dark_onBackground = Color(0xFFE1E2E5)
        override val md_theme_dark_surface = Color(0xFF03141F)
        override val md_theme_dark_onSurface = Color(0xFFE1E2E5)
        override val md_theme_dark_surfaceVariant = Color(0xFF2B3B46)
        override val md_theme_dark_onSurfaceVariant = Color(0xFFA3B0BB)
        override val md_theme_dark_outline = Color(0xFF677885)
    ...
    object LightBlue : ColorScheme {
        ...
        override val md_theme_light_onSecondary = Color(0xFFFFFFFF)
        override val md_theme_light_secondaryContainer = Color(0xFFA3E7E2)
        ...
        override val md_theme_light_onError = Color(0xFFFFFFFF)
        override val md_theme_light_onErrorContainer = Color(0xFF410002)
        override val md_theme_light_background = Color(0xFFC0FFFF)
        override val md_theme_light_onBackground = Color(0xFF191C1C)
        override val md_theme_light_surface = Color(0xFFC0FFFF)
        override val md_theme_light_onSurface = Color(0xFF191C1C)
        override val md_theme_light_surfaceVariant = Color(0xFF93F0DC)
    ...
    object Mint : ColorScheme {
        ...
        override val md_theme_light_onSecondary = Color(0xFFffffff)
        override val md_theme_light_secondaryContainer = Color(0xFFB0E9B8)
        ...
        override val md_theme_light_background = Color(0xFFD1FFE0)
        override val md_theme_light_onBackground = Color(0xFF191c1a)
        override val md_theme_light_surface = Color(0xFFD1FFE0)
        override val md_theme_light_onSurface = Color(0xFF191c1a)
        override val md_theme_light_surfaceVariant = Color(0xFFD2E9CF)
        ...
        override val md_theme_dark_secondaryContainer = Color(0xFF225330)
        ...
        override val md_theme_dark_background = Color(0xFF063C18)
        override val md_theme_dark_onBackground = Color(0xFFe1e3de)
        override val md_theme_dark_surface = Color(0xFF063C18)
        override val md_theme_dark_onSurface = Color(0xFFe1e3de)
        override val md_theme_dark_surfaceVariant = Color(0xFF2F4732)
    ...
    object Green : ColorScheme {
        ...
        override val md_theme_light_onSecondary = Color(0xFFffffff)
        override val md_theme_light_secondaryContainer = Color(0xFFBBE7A0)
        ...
        override val md_theme_light_onError = Color(0xFFffffff)
        override val md_theme_light_onErrorContainer = Color(0xFF410001)
        override val md_theme_light_background = Color(0xFFCBFFC5)
        override val md_theme_light_onBackground = Color(0xFF1a1c19)
        override val md_theme_light_surface = Color(0xFFD9FFC5)
        override val md_theme_light_onSurface = Color(0xFF1a1c19)
        override val md_theme_light_surfaceVariant = Color(0xFFD3E4BF)
        ...
        override val md_theme_dark_secondaryContainer = Color(0xFF37572D)
        ...
        override val md_theme_dark_onError = Color(0xFF680003)
        override val md_theme_dark_onErrorContainer = Color(0xFFffdad4)
        override val md_theme_dark_background = Color(0xFF173806)
        override val md_theme_dark_onBackground = Color(0xFFe2e3dc)
        override val md_theme_dark_surface = Color(0xFF173806)
        override val md_theme_dark_onSurface = Color(0xFFe2e3dc)
        override val md_theme_dark_surfaceVariant = Color(0xFF394631)
    ...
    object Yellow : ColorScheme {
        ...
        override val md_theme_light_onSecondary = Color(0xFFffffff)
        override val md_theme_light_secondaryContainer = Color(0xFFE2DE8C)
        ...
        override val md_theme_light_onError = Color(0xFFffffff)
        override val md_theme_light_onErrorContainer = Color(0xFF410001)
        override val md_theme_light_background = Color(0xFFFFFFC2)
        override val md_theme_light_onBackground = Color(0xFF1c1c16)
        override val md_theme_light_surface = Color(0xFFFFFFC2)
        override val md_theme_light_onSurface = Color(0xFF1c1c16)
        override val md_theme_light_surfaceVariant = Color(0xFFE6DDAB)
        ...
        override val md_theme_dark_secondaryContainer = Color(0xFF4B4B24)
        ...
        override val md_theme_dark_onError = Color(0xFF680003)
        override val md_theme_dark_onErrorContainer = Color(0xFFffdad4)
        override val md_theme_dark_background = Color(0xFF2C2C05)
        override val md_theme_dark_onBackground = Color(0xFFe5e2d9)
        override val md_theme_dark_surface = Color(0xFF2C2C05)
    ...
    object Carrot : ColorScheme {
        ...
        override val md_theme_light_onSecondary = Color(0xFFFFFFFF)
        override val md_theme_light_secondaryContainer = Color(0xFFEEDDA8)
        ...
        override val md_theme_light_onError = Color(0xFFFFFFFF)
        override val md_theme_light_onErrorContainer = Color(0xFF410002)
        override val md_theme_light_background = Color(0xFFFFF2D1)
        override val md_theme_light_onBackground = Color(0xFF1D1B16)
        override val md_theme_light_surface = Color(0xFFFFF2D1)
        ...
        override val md_theme_dark_secondaryContainer = Color(0xFF4E4520)
        ...
        override val md_theme_dark_onError = Color(0xFF690005)
        override val md_theme_dark_onErrorContainer = Color(0xFFFFDAD6)
        override val md_theme_dark_background = Color(0xFF3F2F06)
        override val md_theme_dark_onBackground = Color(0xFFE7E2D9)
        override val md_theme_dark_surface = Color(0xFF3F2F06)
    ...
    object Orange : ColorScheme {
        ...
        override val md_theme_light_onPrimary = Color(0xFFffffff)
        override val md_theme_light_primaryContainer = Color(0xFFF8AF7B)
        override val md_theme_light_onPrimaryContainer = Color(0xFF301400)
        override val md_theme_light_secondary = Color(0xFF755945)
        override val md_theme_light_onSecondary = Color(0xFFffffff)
        override val md_theme_light_secondaryContainer = Color(0xFFFFCAA3)
        override val md_theme_light_onSecondaryContainer = Color(0xFF2a1708)
        override val md_theme_light_tertiary = Color(0xFF4A6135)
        override val md_theme_light_onTertiary = Color(0xFFffffff)
        override val md_theme_light_tertiaryContainer = Color(0xFFBFDDA9)
        override val md_theme_light_onTertiaryContainer = Color(0xFF0B1D00)
        override val md_theme_light_error = Color(0xFFba1b1b)
        override val md_theme_light_errorContainer = Color(0xFFffdad4)
        override val md_theme_light_onError = Color(0xFFffffff)
        override val md_theme_light_onErrorContainer = Color(0xFF410001)
        override val md_theme_light_background = Color(0xFFFFEBD6)
        override val md_theme_light_onBackground = Color(0xFF201a17)
        override val md_theme_light_surface = Color(0xFFFFEBD6)
        ...
        override val md_theme_dark_tertiary = Color(0xFFAECA95)
        override val md_theme_dark_onTertiary = Color(0xFF1C330B)
        override val md_theme_dark_tertiaryContainer = Color(0xFF2C4920)
        override val md_theme_dark_onTertiaryContainer = Color(0xFFC2E6AF)
        override val md_theme_dark_error = Color(0xFFffb4a9)
        override val md_theme_dark_errorContainer = Color(0xFF930006)
        override val md_theme_dark_onError = Color(0xFF680003)
        override val md_theme_dark_onErrorContainer = Color(0xFFffdad4)
        override val md_theme_dark_background = Color(0xFF411805)
        override val md_theme_dark_onBackground = Color(0xFFece0da)
        override val md_theme_dark_surface = Color(0xFF411805)
    ...
    object Red : ColorScheme {
        ...
        override val md_theme_light_onPrimary = Color(0xFFffffff)
        override val md_theme_light_primaryContainer = Color(0xFFEB998A)
        ...
        override val md_theme_dark_tertiaryContainer = Color(0xFF305618)
        override val md_theme_dark_onTertiaryContainer = Color(0xFFD0FBA5)
        override val md_theme_dark_error = Color(0xFFffb4a9)
        override val md_theme_dark_errorContainer = Color(0xFF930006)
        override val md_theme_dark_onError = Color(0xFF680003)
        override val md_theme_dark_onErrorContainer = Color(0xFFffdad4)
        override val md_theme_dark_background = Color(0xFF3C0C04)
        override val md_theme_dark_onBackground = Color(0xFFede0de)
        override val md_theme_dark_surface = Color(0xFF3C0C04)
    ...
    object Pink : ColorScheme {
        ...
        override val md_theme_dark_secondaryContainer = Color(0xFF522738)
        ...
        override val md_theme_dark_onError = Color(0xFF680003)
        override val md_theme_dark_onErrorContainer = Color(0xFFffdad4)
        override val md_theme_dark_background = Color(0xFF44051A)
        override val md_theme_dark_onBackground = Color(0xFFebe0e2)
        override val md_theme_dark_surface = Color(0xFF44051A)
    ...
    object Violet : ColorScheme {
        ...
        override val md_theme_light_onPrimary = Color(0xFFFFFFFF)
        override val md_theme_light_primaryContainer = Color(0xFFDABBFF)
        override val md_theme_light_onPrimaryContainer = Color(0xFF280056)
        override val md_theme_light_secondary = Color(0xFF645A70)
        override val md_theme_light_onSecondary = Color(0xFFFFFFFF)
        override val md_theme_light_secondaryContainer = Color(0xFFE2C9F8)
        ...
        override val md_theme_light_onError = Color(0xFFFFFFFF)
        override val md_theme_light_onErrorContainer = Color(0xFF410002)
        override val md_theme_light_background = Color(0xFFEEE1FF)
        override val md_theme_light_onBackground = Color(0xFF1D1B1E)
        override val md_theme_light_surface = Color(0xFFEEE1FF)
        override val md_theme_light_onSurface = Color(0xFF1D1B1E)
        override val md_theme_light_surfaceVariant = Color(0xFFE0C4EB)
        ...
        override val md_theme_dark_secondaryContainer = Color(0xFF3E2E52)
        ...
        override val md_theme_dark_onError = Color(0xFF690005)
        override val md_theme_dark_onErrorContainer = Color(0xFFFFDAD6)
        override val md_theme_dark_background = Color(0xFF170235)
        override val md_theme_dark_onBackground = Color(0xFFE7E1E6)
        override val md_theme_dark_surface = Color(0xFF170235)
    ...
    object Purple : ColorScheme {
        ...
        override val md_theme_light_onPrimary = Color(0xFFffffff)
        override val md_theme_light_primaryContainer = Color(0xFFFFBFFF)
        override val md_theme_light_onPrimaryContainer = Color(0xFF35003f)
        override val md_theme_light_secondary = Color(0xFF6c586b)
        override val md_theme_light_onSecondary = Color(0xFFffffff)
        override val md_theme_light_secondaryContainer = Color(0xFFF3C7EC)
        ...
        override val md_theme_light_onError = Color(0xFFffffff)
        override val md_theme_light_onErrorContainer = Color(0xFF410001)
        override val md_theme_light_background = Color(0xFFFCE6FF)
        override val md_theme_light_onBackground = Color(0xFF1e1a1d)
        override val md_theme_light_surface = Color(0xFFFCE6FF)
        override val md_theme_light_onSurface = Color(0xFF1e1a1d)
        override val md_theme_light_surfaceVariant = Color(0xFFECC6E1)
        ...
        override val md_theme_dark_secondaryContainer = Color(0xFF502C4E)
